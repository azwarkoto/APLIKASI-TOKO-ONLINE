             ...
             <?php echo form_error('nama', '<div class="text-danger
                ...
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="password" class="form-control form-control-user" id="exampleInputPassword" placeholder="Ulangi Password " name="password_1">
              ...
              <div class="text-center"> 
                ...
                ">Sudah Punya Akun? Silahkan Login</a>
